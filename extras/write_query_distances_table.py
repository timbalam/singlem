...
from singlem.sequence_classes import Sequence, UnalignedAlignedNucleotideSequence
from singlem.taxonomy import *
from singlem.pipe_taxonomy_assigner_by_query import PipeTaxonomyAssignerByQuery
from singlem.sequence_database import ANNOY_INDEX_FORMAT, SCANN_INDEX_FORMAT, SCANN_NAIVE_INDEX_FORMAT, SMAFA_NAIVE_INDEX_FORMAT


def debug_write_query_distances_table(input_archive_otu_table, metapackage_path, output_dir,
                                      threads, singlem_assignment_method):
        ...
        with tempfile.TemporaryDirectory(prefix='singlem-renew') as td:
            ...
            pipe._filter_minimum_nucleotide = filter_minimum_nucleotide
            pipe._max_species_divergence = max_species_divergence
            pipe._diamond_top = diamond_top
            results = pipe.assign_taxonomy(
