...
def add_condense_arguments(parser):
    ...
    optional_condense_arguments.add_argument('--joint-sylph-weight', type=float, default=1.0,
        help="[--joint] weight for sylph coverage estimates relative to singlem OTUs [default: 1.0]")
...
def main():
    ...
    if args.subparser_name=='pipe':
        ...
        Condenser().condense(
            ...
            joint_sylph_weight = args.joint_sylph_weight)
