...
class Tests(unittest.TestCase):
    ...
    def test_apply_nonneg_matrix_factorisation_core_split2(self):
        ...
        otus.fields = ArchiveOtuTable.FIELDS_VERSION5
        otus.data = [
            ['g1', 'sample1', 'seq1', 1,1.1,'Root;d__Bacteria;p;c;o;f;g','','','','',['Root; d__Bacteria; p;c;o;f;g'],QUERY_BASED_ASSIGNMENT_METHOD,[]],
    ...
    def test_apply_nonneg_matrix_factorisation_core_genus(self):
        ...
        species_to_coverage, _, _ = Condenser()._apply_nonneg_matrix_factorisation_core(otus, genes_per_domain = {'Bacteria': ['g1']})
        self.assertEqual(
    ...
    def test_apply_nonneg_matrix_factorisation_core_expaper(self):
        ...
        self.assertEqual(
            {'Root;d__Bacteria;p;c;o;f;g;tax1': 8.67,
             'Root;d__Bacteria;p;c;o;f;g;tax2': 0.67},
            species_to_coverage
        )
        ...
        new_data = [
            ['g1', 'sample1', 'seq1', 1, 9.286, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g1', 'sample1', 'seq1', 1, 0.714, 'Root;d__Bacteria;p;c;o;f;g;tax2', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g2', 'sample1', 'seq2', 1, 8.0, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1'], QUERY_BASED_ASSIGNMENT_METHOD, []]
        ]
        self.assertEqual(
            new_data,
            coverage_parts_otus.data
    ...
    def test_apply_nonneg_matrix_factorisation_core_expaper_max_steps(self):
        otus = ArchiveOtuTable()
        otus.fields = ArchiveOtuTable.FIELDS_VERSION5
        otus.data = [
            ['g1', 'sample1', 'seq1', 1, 10, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
        ...
        new_data = [
            ['g1', 'sample1', 'seq1', 1, 9.262, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g1', 'sample1', 'seq1', 1, 0.738, 'Root;d__Bacteria;p;c;o;f;g;tax2', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g2', 'sample1', 'seq2', 1, 8, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1'], QUERY_BASED_ASSIGNMENT_METHOD, []]
        ]
        self.assertEqual(
            new_data,
    ...
    def test_apply_nonneg_matrix_factorisation_core_exparts(self):
        ...
        new_otus.data = [
            ['g1', 'sample1', 'seq1', 1, 8.0, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g1', 'sample1', 'seq1', 1, 4.0, 'Root;d__Bacteria;p;c;o;f;g;tax2', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1','Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g1', 'sample1', 'seq2', 1, 3.0, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g2', 'sample1', 'seq3', 1, 11.0, 'Root;d__Bacteria;p;c;o;f;g;tax1', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax1'], QUERY_BASED_ASSIGNMENT_METHOD, []],
            ['g2', 'sample1', 'seq4', 1, 4.0, 'Root;d__Bacteria;p;c;o;f;g;tax2', '', '', '', '', ['Root; d__Bacteria; p;c;o;f;g; tax2'], QUERY_BASED_ASSIGNMENT_METHOD, []]
        ]
        self.assertEqual(
            new_otus.data,
            coverage_parts_otus.data
    ...
    def test_apply_nonneg_matrix_factorisation_core_exparts_reg(self):
        ...
        species_to_coverage, _, _ = Condenser()._apply_nonneg_matrix_factorisation_core(
            otus,
            genes_per_domain = {'Bacteria': ['g1', 'g2']},
            coverage_rank_penalty = [0.2] * 7 + [0.1]
        )
        self.assertEqual(
            {'Root;d__Bacteria;p;c;o;f;g;tax1': 10.98,
             'Root;d__Bacteria;p;c;o;f;g;tax2': 3.97},
            species_to_coverage
        )
    ...
    def test_apply_nonneg_matrix_factorisation_core_expart_s_mask(self):
        ...
        self.assertEqual(
            {'NMF loss': 0.0, 'NMF mask loss': 0.995, 'NMF steps': 22},
            loss
        )
