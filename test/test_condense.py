...
class Tests(unittest.TestCase):
    ...
    def test_apply_nonneg_matrix_factorisation_core_trivial(self):
        ...
        self.assertEqual(
            {'NMF loss': 0.0, 'NMF penalised loss': 0.0, 'NMF steps' : 2},
            loss
        )
    ...
    def test_apply_nonneg_matrix_factorisation_core_exparts(self):
        ...
        self.assertEqual(
            {'NMF loss': 0.0, 'NMF penalised loss': 0.0, 'NMF steps': 12},
            loss
        )
    ...
    def test_apply_nonneg_matrix_factorisation_core_expart_s_mask(self):
        ...
        self.assertEqual(
            {'NMF loss': 0.0, 'NMF mask loss': 0.995, 'NMF penalised loss': 0.0, 'NMF steps': 22},
            loss
        )
